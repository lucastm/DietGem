...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
    if (req.method === 'GET') {
        try {
            ...
            const prompt = "Gere uma mensagem inicial de boas vindas criativa para o aplicativo DietGem. Não exagere em referências de gema, pedras preciosas, etc. Finalize a mensagem perguntando sobre o perfil do usuário e seus objetivos."
